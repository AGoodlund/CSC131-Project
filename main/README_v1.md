...
# Downlaod XAMPP. I picked the version 8.0.28 / PHP 8.0.28 for Windows
# Install XAMPP. Just keep pressing 'next'. All the default options are good
# Now open XAMPP and start Apache and MySQL. You might need to give permissions to both or one of them. 
...
# Now it should run
# In XAMPP, press start for Apache and MySQL
# Now put https://localhost in your google browser WHILE XAMPP IS RUNNING! 
# Then go to htps://localhost/phpMyAdmin
# If your port number is not 3306, you will get an error stating that you have the wrong credentials.
...
# id will be an INT and phrase will be a TEXT
